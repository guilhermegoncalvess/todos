...
export default createGlobalStyle`
    ...
    .todo-list li .toggle + label {
        ...
        /*Consulta no w3school link para ver como foi gerado*/
    ...
    .todo-list li .toggle:checked + label {
        ...
        /*Foi quando o todo é marcado como completed*/
        color: #d9d9d9;
    ...
    /*Foi movido o treco para quando o toggle:cheked é verdadeiro*/
